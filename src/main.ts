...
const vi: Record<string, string> = {
  ...
  caseStudy:'Xem chi tiết',roberpLine:'Quản lý doanh nghiệp cho thị trường Pháp — từ nhân sự, tài liệu đến vận hành.',roberpKind:'Đóng góp cả frontend & backend',roberpArtCaption:'Giao diện minh họa · không phải ảnh chụp sản phẩm.',glLine:'Đồng hành từ ngày mua nhà đến cuộc sống hằng ngày.',glIntro:'Theo dõi thanh toán, đặt lịch nhận nhà, cập nhật tin tức và kết nối với chủ đầu tư — trên một ứng dụng của Gamuda Land.',glReleased:'Đã phát hành trên iOS & Android',glMediaCredit:'Ảnh giới thiệu chính thức từ Google Play · Gamuda Land',gdosLine:'Vận hành bất động sản & bàn giao',aienLine:'Nền tảng học tập có AI hỗ trợ',
